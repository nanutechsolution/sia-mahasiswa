<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        @if(!$showForm)
        <button wire:click="create" class="inline-flex items-center px-5 py-2.5 bg-unmaris-gold text-unmaris-blue rounded-xl font-black text-sm shadow-lg shadow-orange-500/20 hover:bg-unmaris-yellow hover:scale-105 transition-all">
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden animate-in zoom-in-95 duration-200">
        <div class="px-8 py-5 border-b border-slate-100 bg-slate-50 flex items-center justify-between">
            <h3 class="text-sm font-bold text-unmaris-blue uppercase tracking-wider flex items-center gap-2">
                @if($editMode)
                    <svg class="w-5 h-5 text-unmaris-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                    Edit Fakultas
                @else
        ...
        <div class="p-8 space-y-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" wire:model="kode_fakultas" class="block w-full rounded-lg border-slate-300 focus:border-unmaris-blue focus:ring-unmaris-blue text-sm font-bold uppercase placeholder-slate-300">
                ...
                <div>
                    ...
                    <input type="text" wire:model="nama_fakultas" class="block w-full rounded-lg border-slate-300 focus:border-unmaris-blue focus:ring-unmaris-blue text-sm font-bold placeholder-slate-300">
