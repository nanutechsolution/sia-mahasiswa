<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-black text-unmaris-blue">Master Program Kelas</h1>
        ...
        <div class="flex gap-2">
            ...
            <button wire:click="create" class="inline-flex items-center px-5 py-2.5 bg-unmaris-blue text-white rounded-xl font-black text-sm shadow-lg shadow-blue-500/20 hover:bg-unmaris-gold hover:text-unmaris-blue hover:scale-105 transition-all">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-8 space-y-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <input type="text" wire:model="kode_internal" class="block w-full rounded-xl border-slate-200 bg-slate-50 text-slate-900 py-2.5 pl-4 text-sm font-bold uppercase focus:ring-unmaris-blue focus:border-unmaris-blue" placeholder="REG">
                ...
                <div class="lg:col-span-2">
                    ...
                    <input type="text" wire:model="nama_program" class="block w-full rounded-xl border-slate-200 bg-slate-50 text-slate-900 py-2.5 pl-4 text-sm font-bold focus:ring-unmaris-blue focus:border-unmaris-blue placeholder-slate-400" placeholder="Reguler Pagi">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" wire:model="min_pembayaran_persen" class="block w-full rounded-xl border-slate-200 bg-slate-50 text-slate-900 py-2.5 pl-4 pr-10 text-sm font-bold text-center focus:ring-unmaris-blue focus:border-unmaris-blue" placeholder="50">
                ...
                <div class="flex items-center pt-6 lg:col-span-4">
                    <label class="flex items-center cursor-pointer gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100 w-full hover:border-slate-200 transition-colors">
                        <input type="checkbox" wire:model="is_active" class="w-5 h-5 text-unmaris-blue rounded border-slate-300 focus:ring-unmaris-blue">
                        <div>
            ...
            <div class="pt-6 border-t border-slate-100 flex justify-end gap-3">
                ...
                <button wire:click="save" class="px-8 py-2.5 bg-unmaris-blue text-white rounded-xl text-sm font-bold shadow-lg shadow-indigo-900/20 hover:bg-[#001a38] hover:scale-105 transition-all">Simpan Data</button>
            </div>
        </div>
    </div>
    @endif
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="p-4 bg-slate-50/50 border-b flex items-center gap-4 rounded-t-2xl">
            <div class="relative flex-1">
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari Program..." class="w-full pl-10 pr-4 py-2 rounded-xl border-slate-200 text-sm focus:ring-unmaris-blue focus:border-unmaris-blue transition-shadow outline-none font-bold text-slate-700 placeholder-slate-400">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors group">
                        <td class="px-6 py-4 align-middle">
                            <span class="font-mono text-xs font-black text-unmaris-blue bg-indigo-50 px-2 py-0.5 rounded border border-indigo-100">{{ $p->kode_internal }}</span>
                        </td>
                        <td class="px-6 py-4 align-middle">
