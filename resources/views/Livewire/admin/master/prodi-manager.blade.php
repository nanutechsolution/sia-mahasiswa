        ...
        <div class="p-8 space-y-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="col-span-2">
                    ...
                    <select wire:model="fakultas_id" class="w-full rounded-xl border-slate-200 bg-slate-50 text-slate-900 py-2.5 pl-4 text-sm font-bold focus:ring-[#002855] focus:border-[#002855]">
                ...
                <div class="col-span-2">
                    ...
                    <input type="text" wire:model="nama_prodi" class="w-full rounded-xl border-slate-200 bg-slate-50 text-slate-900 py-2.5 pl-4 text-sm font-bold focus:ring-[#002855] placeholder-slate-400" placeholder="Teknik Informatika">
                ...
                <div>
                    ...
                    <input type="text" wire:model="kode_prodi_internal" class="w-full rounded-xl border-slate-200 bg-slate-50 text-slate-900 py-2.5 pl-4 text-sm font-bold uppercase focus:ring-[#002855]" placeholder="TI">
                ...
                <div>
                    ...
                    <input type="text" wire:model="kode_prodi_dikti" class="w-full rounded-xl border-slate-200 bg-slate-50 text-slate-900 py-2.5 pl-4 text-sm font-bold focus:ring-[#002855]" placeholder="55201">
                </div>

                <div>
                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Jenjang</label>
                    <select wire:model="jenjang" class="w-full rounded-xl border-slate-200 bg-slate-50 text-slate-900 py-2.5 pl-4 text-sm font-bold focus:ring-[#002855]">
                ...
                <div>
                    ...
                    <input type="text" wire:model="gelar_lulusan" class="w-full rounded-xl border-slate-200 bg-slate-50 text-slate-900 py-2.5 pl-4 text-sm font-bold focus:ring-[#002855]" placeholder="S.Kom">
                </div>
                ...
                <div class="col-span-2 lg:col-span-4 bg-indigo-50/50 p-4 rounded-xl border border-indigo-100 mt-2">
                    ...
                    <div class="flex flex-col md:flex-row gap-4 items-start">
                        <div class="flex-1 w-full">
                            <input type="text" wire:model="format_nim" class="w-full rounded-xl border-indigo-200 bg-white text-indigo-900 py-2.5 pl-4 text-sm font-mono font-bold focus:ring-[#002855]">
                            <p class="text-[10px] text-indigo-500/80 mt-2 font-medium">
                                Variabel: <span class="bg-white px-1 rounded border border-indigo-100">{THN}</span> (2 Digit Thn), <span class="bg-white px-1 rounded border border-indigo-100">{TAHUN}</span> (4 Digit), <span class="bg-white px-1 rounded border border-indigo-100">{KODE}</span> (Kode Dikti), <span class="bg-white px-1 rounded border border-indigo-100">{INTERNAL}</span>, <span class="bg-white px-1 rounded border border-indigo-100">{NO:4}</span> (Urutan).
                            </p>
                        </div>
                        <div class="w-full md:w-auto bg-white p-3 rounded-lg border border-indigo-100 shadow-sm">
                            ...
                            <p class="text-sm font-mono font-black text-[#002855]">25552010001</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="pt-6 border-t border-slate-100 flex justify-end gap-3">
                ...
                <button wire:click="save" class="px-8 py-2.5 bg-[#002855] text-white rounded-xl text-sm font-bold shadow-lg hover:bg-[#001a38] transition-all">Simpan Data</button>
            </div>
        </div>
    </div>
    @endif
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="p-4 bg-slate-50/50 border-b flex items-center gap-4 rounded-t-2xl">
            <div class="relative flex-1">
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari Prodi..." class="w-full pl-10 pr-4 py-2 rounded-xl border-slate-200 text-sm focus:ring-[#002855] focus:border-[#002855] transition-shadow outline-none font-bold text-slate-700 placeholder-slate-400">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    @empty
                    <tr><td colspan="7" class="px-6 py-16 text-center text-slate-400 italic">Data tidak ditemukan.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
