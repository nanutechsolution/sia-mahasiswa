    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-50 w-72 bg-unmaris-blue text-white shadow-2xl transition-transform duration-300 ease-in-out md:static md:translate-x-0 flex flex-col h-full border-r border-unmaris-dark">
            ...
            <nav class="flex-1 overflow-y-auto px-4 py-4 space-y-1 sidebar-scroll">
                ...
                {{-- Submenu Master Data --}}
                @php
                $masterRoutes = ['admin.master.fakultas', 'admin.master.prodi', 'admin.master.program-kelas', 'admin.matakuliah', 'admin.kurikulum*', 'admin.skala-nilai', 'admin.aturan-sks', 'admin.master.ruang'];
                ...
                <div x-data="{ open: {{ $isMasterActive ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" class="pl-9 space-y-1 mt-1 border-l-2 border-white/10 ml-5" x-cloak x-transition>
                        ...
                        <a href="{{ route('admin.master.ruang') }}" class="nav-link text-xs py-2 {{ request()->routeIs('admin.master.ruang') ? 'text-unmaris-gold font-bold bg-white/5' : 'text-slate-400' }}" wire:navigate> Data Ruangan</a>
                ...
                <a href="{{ route('admin.jadwal-ujian') }}" class="nav-link {{ request()->routeIs('admin.jadwal-ujian') ? 'active' : '' }}" wire:navigate>
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.ploting.kurikulum') }}" class="nav-link {{ request()->routeIs('admin.ploting.kurikulum') ? 'active' : '' }}" wire:navigate>
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                    </svg>
                    Ploting Kurikulum
                ...
                <a href="{{ route('admin.akademik.import-nilai') }}" class="nav-link {{ request()->routeIs('admin.akademik.import-nilai') ? 'active' : '' }}" wire:navigate>
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.keuangan.import-tagihan') }}" class="nav-link {{ request()->routeIs('admin.keuangan.import-tagihan') ? 'active' : '' }}" wire:navigate>
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    Import Tagihan Massal
                </a>
                ...
                <a href="{{ route('mhs.absensi.scan') }}" class="nav-link {{ request()->routeIs('mhs.absensi.scan') ? 'active' : '' }}" wire:navigate>
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                    </svg>
                    Absensi
                ...
                <a href="{{ route('dosen.manager-kelas') }}" class="nav-link {{ request()->routeIs('dosen.manager-kelas') ? 'active' : '' }}" wire:navigate>
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                    </svg>
                    Presensi
