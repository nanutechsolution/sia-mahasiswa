...
namespace App\Livewire\PowerGridThemes;

use \PowerComponents\LivewirePowerGrid\Themes\Tailwind;

class UnmarisTheme extends Tailwind
{
    ...
    public function table(): array
    {
        return [
            ...
            'header' => [
                'thead'    => 'shadow-sm rounded-t-lg bg-[#002855] dark:bg-pg-primary-900',
                'tr'       => '',
                'th'       => 'font-extrabold px-3 py-3 text-left text-xs text-white tracking-wider whitespace-nowrap dark:text-pg-primary-300',
                'thAction' => '!font-bold',
            ],
